...
const Footer = () => {
  ...
  return (
    <footer className="bg-theme-gradient py-6 lg:py-2  min-h-28 z-50  relative">
      <div className="xl:px-10 sm:px-6 px-4  min-h-28  flex lg:flex-row flex-col  lg:gap-0 gap-5  justify-between items-center ">
        ...
        <p className="w-fit  flex items-center text-white text-sm">
          <span>&copy;{currentYear} KeepSafe</span>
        </p>

        <div className="flex-1  flex flex-row gap-6 lg:justify-end justify-start items-center">
          <Link
            className="text-white border h-10 w-10 flex justify-center items-center border-white rounded-xl p-2 hover:bg-[#E5E7EB] hover:text-black transition-colors duration-300"
